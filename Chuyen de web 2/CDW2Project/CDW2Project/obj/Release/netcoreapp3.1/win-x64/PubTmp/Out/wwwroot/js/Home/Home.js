$(document).ready(() => {
                    ...
                    getList.articleList.forEach((value, index) => {
                        ...
                        newLeftBox.insertAdjacentHTML("beforeend", '<div class="new__left__box__item">' +
                            ...
                            '                    <div class="new__left__box__item__left__link">' +
                                                    AddArticleType(value.articleType) +
                            '                    </div>' +
    ...
    //Handle Add ArticleType 
    function AddArticleType(articleType) {
        if (Object.keys(articleType).length > 0) {
            return '<div style="display: flex; align - items: center; ">' +
                `${articleType.image}` +
                '<h4 style="margin: 0; margin-left: 8px;">' + `${articleType.name}` + '</h4>' +
                '</div>';
        }
    }
